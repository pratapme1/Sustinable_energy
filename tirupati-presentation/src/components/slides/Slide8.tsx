...
import { DollarSign, PieChart, TrendingUp, Landmark, ShieldCheck } from "lucide-react";
  ...
  return (
    <div className="flex flex-col justify-center space-y-12">
      <div className="space-y-4">
        ...
        >
          Four <span className="text-gradient-gold italic">Revenue Streams</span> per Plant
        </motion.h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          {[
            {
              ...
              val: "₹24.3 Crore",
              desc: "15-year offtake. Floor ₹46/kg. Realistic ₹62–72/kg.",
              p: "71%"
            },
            {
              icon: ShieldCheck,
            ...
            },
            {
              ...
              val: "₹2.15 Crore",
              desc: "SWM 2026 mandate. TMC + Pilgrim Hotels pay to dispose.",
              p: "6%"
            },
            {
              icon: TrendingUp,
        ...
        >
          ...
          <div className="space-y-2">
            <h3 className="text-5xl font-extrabold text-white tracking-tighter italic italic tracking-widest text-gradient-gold">₹32.6 Crore</h3>
          ...
          <div className="p-6 glass rounded-2xl border-brand-gold/20 backdrop-blur-md">
            <p className="text-xs text-slate-400 leading-relaxed italic">
              ...
              providing multi-source revenue shielding for the investor."
            </p>
          </div>
        </motion.div>
      </div>
